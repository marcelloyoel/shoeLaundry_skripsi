    ...
    <form method="POST" action="/laundrysepatu/{{ $laundry->id }}" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control @error('laundrySepatuName') is-invalid @enderror"
                    id="laundrySepatuName" value="{{ old('laundrySepatuName', $laundry->laundrySepatuName) }}"
                    name="laundrySepatuName">
            ...
            <div class="form-group col-md-6">
                ...
                <input disabled type="text" class="form-control @error('laundrySepatuSlug') is-invalid @enderror"
                    id="laundrySepatuSlug" value="{{ old('laundrySepatuSlug', $laundry->slug) }}" name="laundrySepatuSlug">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control @error('Address') is-invalid @enderror" rows="3" id="Address" name="Address">{{ old('Address', $laundry->Address) }}</textarea>
                @error('Address')
                    <div class="invalid-feedback mb-2">
                        {{ $message }}
                    </div>
